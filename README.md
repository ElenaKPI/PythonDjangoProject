...
- використовувати навчений згортковий нейронний класифікатор емоцій
- визначати емоційний стан людини (happy, sad, angry, neutral тощо)
- відображати результат класифікації та рівень впевненості

Модель працює з зображеннями облич та базується на згортковій нейронній мережі,
навченій на датасеті з емоційними виразами облич.
